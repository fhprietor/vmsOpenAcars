...
| **IVAO Offline** | −5 pts | −5 si el vuelo se inició sin conexión activa a IVAO |
...
| **IVAO** | Conéctate a la red IVAO antes de hacer START |
...
*vmsOpenAcars v0.4.2 — que tengas buen vuelo.*
